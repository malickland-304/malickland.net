          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1C3A1C]/30 focus:border-[#1C3A1C]"
              />
            </div>
            <select className="border border-slate-300 rounded-lg px-3 py-2.5 text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-[#1C3A1C]/30">
            ...
            <button className="bg-[#1C3A1C] hover:bg-[#142814] text-white px-6 py-2.5 rounded-lg text-sm font-semibold transition-colors">
              Search
            </button>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sampleListings.map((listing) => (
            ...
            >
              {/* Photo placeholder */}
              <div className="h-48 bg-gradient-to-br from-[#1C3A1C] to-[#254E25] flex items-center justify-center relative">
                ...
                <div className="absolute top-3 left-3 flex gap-2">
                  ...
                  <span className="bg-[#1C3A1C]/80 text-white text-xs font-medium px-2.5 py-1 rounded-full">
                    {listing.type}
                  </span>
                </div>
                <div className="absolute bottom-3 right-3 bg-[#C4A040] text-white font-bold px-3 py-1.5 rounded-lg text-sm">
              ...
              {/* Details */}
              <div className="p-5">
                <h3 className="font-bold text-[#1C3A1C] text-base leading-tight mb-1">
                  {listing.address}
                </h3>
                ...
                <Link
                  href="/contact"
                  className="w-full bg-[#1C3A1C] hover:bg-[#142814] text-white py-2.5 rounded-lg text-sm font-semibold text-center transition-colors block"
                >
        ...
        {/* Call to action */}
        <div className="mt-12 bg-[#1C3A1C] rounded-2xl p-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              href="/contact"
              className="bg-[#C4A040] hover:bg-[#D4B050] text-white px-8 py-3 rounded-lg font-semibold transition-colors"
            >
